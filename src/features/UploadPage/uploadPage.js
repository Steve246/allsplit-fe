    ...
    return (
        <>
            <Container maxW={'3xl'}>
                ...
                <Text color={'gray.500'}>
                    Snap a picture of your receipt, and our app will extract the details. 
                    <br/> You can then split the expense with friends within seconds. 
                    <br/> No manual data entry required!” 😊
                </Text>
                <Stack
                    direction={'column'}
                    spacing={3}
